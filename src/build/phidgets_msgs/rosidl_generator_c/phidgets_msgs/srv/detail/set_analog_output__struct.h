...
enum
{
  phidgets_msgs__srv__SetAnalogOutput_Event__request__MAX_SIZE = 1
};
// response
enum
{
  phidgets_msgs__srv__SetAnalogOutput_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetAnalogOutput in the package phidgets_msgs.
typedef struct phidgets_msgs__srv__SetAnalogOutput_Event
{
  service_msgs__msg__ServiceEventInfo info;
  phidgets_msgs__srv__SetAnalogOutput_Request__Sequence request;
  phidgets_msgs__srv__SetAnalogOutput_Response__Sequence response;
} phidgets_msgs__srv__SetAnalogOutput_Event;

// Struct for a sequence of phidgets_msgs__srv__SetAnalogOutput_Event.
typedef struct phidgets_msgs__srv__SetAnalogOutput_Event__Sequence
{
