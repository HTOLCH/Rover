...
static const _StepperCommand_type_support_symbol_names_t _StepperCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phidgets_msgs, msg, StepperCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phidgets_msgs, msg, StepperCommand)),
  }
};
...
{
  return &::phidgets_msgs::msg::rosidl_typesupport_cpp::StepperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, phidgets_msgs, msg, StepperCommand)() {
  return get_message_type_support_handle<phidgets_msgs::msg::StepperCommand>();
}
