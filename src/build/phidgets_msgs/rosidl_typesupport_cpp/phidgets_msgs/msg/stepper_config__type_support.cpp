...
static const _StepperConfig_type_support_symbol_names_t _StepperConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phidgets_msgs, msg, StepperConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phidgets_msgs, msg, StepperConfig)),
  }
};
...
{
  return &::phidgets_msgs::msg::rosidl_typesupport_cpp::StepperConfig_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, phidgets_msgs, msg, StepperConfig)() {
  return get_message_type_support_handle<phidgets_msgs::msg::StepperConfig>();
}
