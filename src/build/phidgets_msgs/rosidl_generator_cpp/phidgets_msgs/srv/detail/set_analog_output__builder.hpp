...
{
public:
  explicit Init_SetAnalogOutput_Event_response(::phidgets_msgs::srv::SetAnalogOutput_Event & msg)
  : msg_(msg)
  {}
  ::phidgets_msgs::srv::SetAnalogOutput_Event response(::phidgets_msgs::srv::SetAnalogOutput_Event::_response_type arg)
  {
...
private:
  ::phidgets_msgs::srv::SetAnalogOutput_Event msg_;
};

class Init_SetAnalogOutput_Event_request
{
public:
  explicit Init_SetAnalogOutput_Event_request(::phidgets_msgs::srv::SetAnalogOutput_Event & msg)
  : msg_(msg)
  {}
  Init_SetAnalogOutput_Event_response request(::phidgets_msgs::srv::SetAnalogOutput_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetAnalogOutput_Event_request info(::phidgets_msgs::srv::SetAnalogOutput_Event::_info_type arg)
  {
...
template<>
inline
auto build<::phidgets_msgs::srv::SetAnalogOutput_Event>()
{
  return phidgets_msgs::srv::builder::Init_SetAnalogOutput_Event_info();
}
