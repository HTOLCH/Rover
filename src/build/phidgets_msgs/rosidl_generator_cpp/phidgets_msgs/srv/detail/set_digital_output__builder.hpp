...
{
public:
  explicit Init_SetDigitalOutput_Event_response(::phidgets_msgs::srv::SetDigitalOutput_Event & msg)
  : msg_(msg)
  {}
  ::phidgets_msgs::srv::SetDigitalOutput_Event response(::phidgets_msgs::srv::SetDigitalOutput_Event::_response_type arg)
  {
...
private:
  ::phidgets_msgs::srv::SetDigitalOutput_Event msg_;
};

class Init_SetDigitalOutput_Event_request
{
public:
  explicit Init_SetDigitalOutput_Event_request(::phidgets_msgs::srv::SetDigitalOutput_Event & msg)
  : msg_(msg)
  {}
  Init_SetDigitalOutput_Event_response request(::phidgets_msgs::srv::SetDigitalOutput_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetDigitalOutput_Event_request info(::phidgets_msgs::srv::SetDigitalOutput_Event::_info_type arg)
  {
...
template<>
inline
auto build<::phidgets_msgs::srv::SetDigitalOutput_Event>()
{
  return phidgets_msgs::srv::builder::Init_SetDigitalOutput_Event_info();
}
