...
#ifndef _WIN32
# define DEPRECATED__phidgets_msgs__srv__SetDigitalOutput_Event __attribute__((deprecated))
#else
# define DEPRECATED__phidgets_msgs__srv__SetDigitalOutput_Event __declspec(deprecated)
#endif
...
struct SetDigitalOutput_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<phidgets_msgs::srv::SetDigitalOutput_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<phidgets_msgs::srv::SetDigitalOutput_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<phidgets_msgs::srv::SetDigitalOutput_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<phidgets_msgs::srv::SetDigitalOutput_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<phidgets_msgs::srv::SetDigitalOutput_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<phidgets_msgs::srv::SetDigitalOutput_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<phidgets_msgs::srv::SetDigitalOutput_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<phidgets_msgs::srv::SetDigitalOutput_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__phidgets_msgs__srv__SetDigitalOutput_Event
    std::shared_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__phidgets_msgs__srv__SetDigitalOutput_Event
    std::shared_ptr<phidgets_msgs::srv::SetDigitalOutput_Event_<ContainerAllocator> const>
...
using SetDigitalOutput_Event =
  phidgets_msgs::srv::SetDigitalOutput_Event_<std::allocator<void>>;
...
struct SetDigitalOutput
{
  ...
  using Event = phidgets_msgs::srv::SetDigitalOutput_Event;
};
