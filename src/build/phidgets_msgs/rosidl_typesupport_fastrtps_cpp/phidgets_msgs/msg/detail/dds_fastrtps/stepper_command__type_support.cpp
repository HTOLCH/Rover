...
#include "phidgets_msgs/msg/detail/stepper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const phidgets_msgs::msg::StepperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phidgets_msgs::msg::StepperCommand & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phidgets_msgs::msg::StepperCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phidgets_msgs::msg::StepperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phidgets_msgs::msg::StepperCommand *>(
    untyped_ros_message);
...
{
  return &phidgets_msgs::msg::typesupport_fastrtps_cpp::_StepperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phidgets_msgs, msg, StepperCommand)() {
  return &phidgets_msgs::msg::typesupport_fastrtps_cpp::_StepperCommand__handle;
}
