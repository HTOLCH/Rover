...
static const _StepperCommand_type_support_symbol_names_t _StepperCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phidgets_msgs, msg, StepperCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, phidgets_msgs, msg, StepperCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, phidgets_msgs, msg, StepperCommand)() {
  return &::phidgets_msgs::msg::rosidl_typesupport_c::StepperCommand_message_type_support_handle;
}
