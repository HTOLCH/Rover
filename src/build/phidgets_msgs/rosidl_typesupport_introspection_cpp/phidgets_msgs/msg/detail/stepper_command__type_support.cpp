...
{
  new (message_memory) phidgets_msgs::msg::StepperCommand(_init);
}

void StepperCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<phidgets_msgs::msg::StepperCommand *>(message_memory);
  typed_message->~StepperCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember StepperCommand_message_member_array[3] = {
  {
    "mode",  // name
    ...
    offsetof(phidgets_msgs::msg::StepperCommand, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(phidgets_msgs::msg::StepperCommand, target),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(phidgets_msgs::msg::StepperCommand, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StepperCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(phidgets_msgs::msg::StepperCommand),
...
get_message_type_support_handle<phidgets_msgs::msg::StepperCommand>()
{
  return &::phidgets_msgs::msg::rosidl_typesupport_introspection_cpp::StepperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phidgets_msgs, msg, StepperCommand)() {
  return &::phidgets_msgs::msg::rosidl_typesupport_introspection_cpp::StepperCommand_message_type_support_handle;
}
