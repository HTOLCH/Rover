...
static const _SetAnalogOutput_Event_type_support_symbol_names_t _SetAnalogOutput_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phidgets_msgs, srv, SetAnalogOutput_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phidgets_msgs, srv, SetAnalogOutput_Event)),
  }
};
...
{
  return &::phidgets_msgs::srv::rosidl_typesupport_cpp::SetAnalogOutput_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, phidgets_msgs, srv, SetAnalogOutput_Event)() {
  return get_message_type_support_handle<phidgets_msgs::srv::SetAnalogOutput_Event>();
}
...
static const rosidl_service_type_support_t SetAnalogOutput_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<phidgets_msgs::srv::SetAnalogOutput_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<phidgets_msgs::srv::SetAnalogOutput_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<phidgets_msgs::srv::SetAnalogOutput_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, phidgets_msgs, srv, SetAnalogOutput)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<phidgets_msgs::srv::SetAnalogOutput>();
}
